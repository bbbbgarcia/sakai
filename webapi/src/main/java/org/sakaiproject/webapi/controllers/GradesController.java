...
public class GradesController extends AbstractSakaiApiController {
    ...
    @GetMapping(value = {"/sites/{siteId}/items", "/sites/{siteId}/items/{userId}", "/sites/{siteId}/items/{userId}/{gbUid}"}, produces = MediaType.APPLICATION_JSON_VALUE)
    public List<GradebookRestBean> getSiteItems(@PathVariable String siteId, @PathVariable Optional<String> gbUid,
