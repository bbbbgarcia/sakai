...
public class Assignments extends AbstractWebService {
    ...
    public String setAssignmentGradeCommentforUser(
    	...
    	try
    	{
    		...
    		//TODO s2u-26 ver esto bien - hacer igual que en tareas juanma : ref vs id? 
	    		// probablemente no haga falta recorrer todos los gbs... 
	    		// pero se puede obtener la lista por ref o id y comprobar que existe?
    		for (String gradebookUid : gradebookUids) {
    			// update grade in gradebook
    			integrateGradebook(aReference, associateGradebookAssignment, null, null, -1, null, sReference, "update", gradebookUid, context);
    		}
    	}
    	catch (Exception e)
    	{
                            ...
                            if (associateGradebookAssignment != null)
                            {
                                ...
                                else if (isAssignmentDefined)
                                {
                                    ...
                                    while (submissions.hasNext())
                                    {
                                        ...
                                        gradingService.setAssignmentScoreString(gradebookUid, context, associateGradebookAssignment, submitterId, grade, assignmentToolTitle);
                                    }
                                }
                            }
                    ...
                    else
                    {
                        try
                        {
                            ...
                            if (associateGradebookAssignment != null)
                            {
                                ...
                                else if (gradingService.isAssignmentDefined(gradebookUid, context, associateGradebookAssignment))
                                {
                                    // the associated assignment is internal one, update records
                                    gradingService.setAssignmentScoreString(gradebookUid, context, associateGradebookAssignment, submitter,
                ...
                else if (updateRemoveSubmission.equals("remove"))
                {
                    if (submissionRef == null)
                    {
                        ...
                        while (submissions.hasNext())
                        {
                            ...
                            {
                                gradingService.setAssignmentScoreString(gradebookUid, context, associateGradebookAssignment, submitter, null, assignmentToolTitle);
                            }
                        }
                    }
                    else
