                    ...
                    if (site != null) {
                        ...
                        if (o != null) {
                            if (o instanceof String) {
                                            ...
                                            for (Group g : site.getGroups()) {
                                                try {
                                                    ...
                                                    if (!limitExceeded || countNumberOfChannelsCreated < MAX_ADD_CHANNELS) {
                                                        createdChannelId = microsoftCommonService.createChannel(teamId, g.getTitle(), credentials.getEmail());
                                ...
                                ss.setCreationStatus(CreationStatus.OK);
