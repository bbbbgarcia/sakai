    ...
    <h:column rendered="#{! forum.nonePermission}">
		<h:panelGrid columns="1" styleClass="forumHeader"  border="0">
  	    <h:panelGroup>
				...
				<%-- Rubrics marker --%>
				<h:outputText styleClass="fa fa-th-large" id="rubrics-forum-icon" rendered="#{forum.hasRubric == 'true'}" style="margin-right:.5em" title="#{msgs.cdfm_forum_rubric}"/>
		...
		<h:dataTable id="topics" rendered="#{!empty forum.topics}" value="#{forum.topics}" var="topic"  width="100%"   cellspacing="0" cellpadding="0" border="0">
		   <h:column rendered="#{! topic.nonePermission}">
		      	...
		      	<h:panelGroup>
							...
							<%-- Rubrics marker --%>
							<h:outputText styleClass="fa fa-th-large" id="rubrics-topic-icon" rendered="#{topic.hasRubric == 'true'}" style="margin-right:.5em" title="#{msgs.cdfm_topic_rubric}"/>
